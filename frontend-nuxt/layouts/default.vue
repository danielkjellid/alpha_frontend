...
export default defineComponent({
  ...
  setup() {
    ...
    *******************/
    ...
    let showMessage = ref<HTMLElement | boolean>(false)

    if (process.browser) {
      showMessage = localStorage.getItem('show_message') ? JSON.parse(localStorage.getItem('show_message') as string) : true
    }

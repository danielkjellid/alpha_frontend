    ...
    <div class="relative min-h-screen bg-white">
      <div class="h-full px-5 pt-5 overflow-y-auto" :class="collapsedUserMenuActive ? 'pb-56' : 'pb-24'">
        ...
        <nav class="mt-5 overflow-y-auto">
          ...
          <nuxt-link to="/kjokken/" :class="renderNavbarLinkClasses" :active-class="renderNavbarLinkActiveClasses" class="mt-4">Kjøkken</nuxt-link>
...
<script lang="ts">
import { useStore, useRouter, defineComponent, computed } from '@nuxtjs/composition-api'
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    let collapsedUserMenuActive = false
    ...
    const renderChevronPath = computed(() => {
      if (catalogMenuActive) return 'M14.707 12.707a1 1 0 01-1.414 0L10 9.414l-3.293 3.293a1 1 0 01-1.414-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 010 1.414z'

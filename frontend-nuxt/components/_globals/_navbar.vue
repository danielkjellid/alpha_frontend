          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center">
              ...
              <nav class="lg:block hidden ml-4">
                ...
                <nuxt-link to="/kjokken/" :class="renderNavbarLinkClasses" :active-class="renderNavbarLinkActiveClasses" class="ml-4">Kjøkken</nuxt-link>
...
export default defineComponent({
  ...
  setup() {
    ...
    ***********************/
    ...
    let mobileMenuActive = ref<HTMLElement | boolean>(false)
    let flyoutMenuActive = ref<HTMLElement | boolean>(false)
    ...
    const toggleFlyoutMenu = () => {
      ...
      console.log(flyoutMenuActive.value)
    }
    ...
    ******************/
    ...
    let userMenuActive = ref<HTMLElement | boolean>(false)

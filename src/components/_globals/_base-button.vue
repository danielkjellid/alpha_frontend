...
export default {
  ...
  methods: {
    ...
    renderClasses() {
      ...
      if (this.light) return 'text-sm font-medium leading-5 rounded-md px-4 py-2 text-gray-900 bg-white border border-gray-200 hover:bg-gray-50 hover:border-gray-300 focus:outline-none focus:border-gray-400 focus:shaow-outline-gray active:bg-gray-100 active:border-gray-400'
      ...
      return 'text-sm font-medium leading-5 rounded-md px-4 py-2 text-white bg-gray-800 border border-transparent hover:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring-gray active:bg-gray-900'
    }
  }
}
</script>
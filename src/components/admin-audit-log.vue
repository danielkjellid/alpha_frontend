        ...
        <div class="relative flex items-start pb-6">
          ...
          <div class="relative w-full text-sm">
            <div class="flex items-center justify-between">
              ...
              <p class="text-gray-400">{{ log.date_of_change }}</p>
            </div>
            <div class="mt-3">
              <p class="text-gray-500">{{ log.user }} endret <span class="font-medium text-gray-800">{{ log.change.field }}</span> fra <span class="font-medium text-gray-800">{{ log.change.old_value }}</span> til <span class="font-medium text-gray-800">{{ log.change.new_value }}</span></p>
            </div>
          </div>
        </div>
      </li>
